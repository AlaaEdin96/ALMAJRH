            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="form-group">
                        <button  type="button" onclick='Livewire.emit("openModal", "modal.crud-expenses", {{ json_encode(["project_id" => 1,"taitel"=>"اضافة عهدة","stes"=>true]) }})'  class="btn mb-1 btn-outline-primary btn-icon btn-lg btn-block waves-effect waves-light">اضافة عهدة</button>
                     </div>

                     <div class="form-group">
                        <button  type="button" onclick='Livewire.emit("openModal", "modal.crud-expenses", {{ json_encode(["project_id" => 1,"taitel"=>"ارجاع عهدة","stes"=>true]) }})'  class="btn mb-1 btn-outline-primary btn-icon btn-lg btn-block waves-effect waves-light">ارجاع عهدة</button>
                     </div>
                </div>
                            ...
                            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap4"><div class="row"><div class="col-sm-12 col-md-6"><div class="dataTables_length" id="DataTables_Table_0_length"><label>Show <select name="DataTables_Table_0_length" aria-controls="DataTables_Table_0" class="custom-select custom-select-sm form-control form-control-sm"><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select> entries</label></div></div><div class="col-sm-12 col-md-6"><div id="DataTables_Table_0_filter" class="dataTables_filter"><label>Search:<input type="search" class="form-control form-control-sm" placeholder="" aria-controls="DataTables_Table_0"></label></div></div></div><div class="row"><div class="col-sm-12"><table class="table zero-configuration dataTable" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                ...
                                <tbody>
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td>
                                            <!----$momuel->mony < 0  التأكد في حال كان المبلغ مسترجع---->
                                            @if ($momuel->mony < 0)
                                            <code>${{$momuel->mony * -1}}</code>   
                                            @else
                                            ${{$momuel->mony}}
                                            @endif
                                        </td>
            ...
            <div class="card text-center">
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <h2 class="text-bold-700">{{$masrofats->where('mony','>','0')->sum('mony')}}</h2>
                        <p class="mb-0 line-ellipsis">مجموع العهد الكلية : للمشاريع</p>
                    </div>
                </div>
            </div>
            ...
            <div class="card text-center">
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <h2 class="text-bold-700 t"><code>{{$masrofats->where('mony','<','0')->sum('mony') * -1}}</code></h2>
                        <p class="mb-0 line-ellipsis">مجموع العهد المرتجعه : للمشاريع</p>
                    </div>
                </div>
            </div>
