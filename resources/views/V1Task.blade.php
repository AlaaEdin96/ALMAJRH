                                        ...
                                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                            <ul class="navbar-nav justify-content-around w-75 ml-sm-auto">
                                                <li class="nav-item px-sm-0">
                                                    <a href="#" class="nav-link font-small-3">المنشورات</a>
                                                </li>
                                              
                                                <li class="nav-item px-sm-0">
                                                    <a href="#" class="nav-link font-small-3">الفواتير</a>
                                                </li>
                                                <li class="nav-item px-sm-0">
                                                    <a href="#" class="nav-link font-small-3">جدول العمل</a>
                                                </li>
                                                <li class="nav-item px-sm-0">
                                                  <a href="#" class="nav-link font-small-3">الشركات</a>
                                              </li>
                                            </ul>
                                        </div>
                                    </nav>
